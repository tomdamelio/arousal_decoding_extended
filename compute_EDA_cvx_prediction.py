...
pipelines = {'riemann': TransformedTargetRegressor(
            ...
            'spoc': TransformedTargetRegressor(
                regressor=make_filter_bank_regressor(
                    names=freqs.keys(),
                    method='spoc',
                    ...
                    estimator=estimator_type),
                transformer=QuantileTransformer(n_quantiles=900, output_distribution="normal")),
            'log_diag': TransformedTargetRegressor(
                regressor=make_filter_bank_regressor(
                    names=freqs.keys(),
                    method='log_diag',
                    ...
                    estimator=estimator_type),
                transformer=QuantileTransformer(n_quantiles=900, output_distribution="normal")),
            'upper': TransformedTargetRegressor(
                regressor=make_filter_bank_regressor(
                    names=freqs.keys(),
                    method='naive',
                    projection_params=None,
                    ...
                    estimator=estimator_type),
                transformer=QuantileTransformer(n_quantiles=900, output_distribution="normal")),
            'random': TransformedTargetRegressor(
                regressor=make_filter_bank_regressor(
                    names=freqs.keys(),
                    method='random',
                    projection_params=None,
...
def run_low_rank(n_components, X, y, estimators, cv, scoring):   
    ...
    for key, estimator in estimators.items():
        ...
        for n_pipeline in range(len(freqs)):
            this_est.regressor.steps[0][1].transformers[n_pipeline][1].steps[0][1].n_compo = n_components
