# By running this script, we could check how many stimuli
# are presented in every subject.

# As a result we can see that all subjects have 40 trials (as expected by experimental design).
# But subject 28 which exceptionally has 37 trials.
...
if os.name == 'nt':
    derivative_path = 'C:/Users/dadam/arousal_decoding_extended/outputs/DEAP-bids'  
    annotations_root = pathlib.Path(
        "C:/Users/dadam/arousal_decoding_extended/outputs/annotations_bad_no_stim").expanduser()
else:
...
for subject in subjects:
    ...
    fname_annot = op.join(annotations_root,'sub-'+ subject + '_annot.fif')
