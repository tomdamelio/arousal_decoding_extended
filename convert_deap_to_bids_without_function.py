...
#%%
# setup paths
# path in which data is stored
input_path = Path('C:/Users/dadam/OneDrive/Escritorio/tomas_damelio/data')
# path to store data in DEAP BIDS format
...
if DEBUG:
    input_path_debug = [path for path in input_path.glob("*.bdf")]
    input_path = []
    input_path.append(input_path_debug[0])
